...
public:
    ...
    void setupUi(QWidget *AuthorizationForm)
    {
        ...
        AuthorizationForm->resize(392, 461);
        horizontalLayout = new QHBoxLayout(AuthorizationForm);
        horizontalLayout->setObjectName("horizontalLayout");
        verticalLayout = new QVBoxLayout();
        verticalLayout->setObjectName("verticalLayout");
        Title_label = new QLabel(AuthorizationForm);
        ...
        login_label = new QLabel(AuthorizationForm);
        login_label->setObjectName("login_label");

        login_horizontalLayout->addWidget(login_label);

        login_lineEdit = new QLineEdit(AuthorizationForm);
        ...
        password_label = new QLabel(AuthorizationForm);
        password_label->setObjectName("password_label");

        password_horizontalLayout->addWidget(password_label);

        password_lineEdit = new QLineEdit(AuthorizationForm);
        ...
        email_label = new QLabel(AuthorizationForm);
        email_label->setObjectName("email_label");

        email_horizontalLayout->addWidget(email_label);

        email_lineEdit = new QLineEdit(AuthorizationForm);
        ...
        errorIdentificyLabel = new QLabel(AuthorizationForm);
